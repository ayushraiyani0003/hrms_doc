...
const Header = ({ isDarkMode, toggleDarkMode }) => {
  ...
  const suggestionData = {
    ...
    'Documents': {
      items: [
        ...
        { name: 'Tax Documents', category: 'Documents', image: 'https://icehrm.com/explore/wp-content/uploads/2022/08/Screenshot-from-2022-08-01-10-06-24-1-1024x271.png' }
      ]
    },
    'Projects': {
      items: [
        ...
        { name: 'Resource Planning', category: 'Projects', image: 'https://icehrm.com/explore/wp-content/uploads/2022/08/Screenshot-from-2022-08-01-10-06-24-1-1024x271.png' }
      ]
    },
    'Settings': {
      items: [
        { name: 'User Preferences', category: 'Settings', image: null },
        { name: 'System Configuration', category: 'Settings', image: 'https://icehrm.com/explore/wp-content/uploads/2022/08/Screenshot-from-2022-08-01-10-06-24-1-1024x271.png' },
  ...
  return (
    <header className={`w-full px-6 py-3 shadow-lg transition-colors duration-400 ${
      isDarkMode 
      ...
      <div className="mx-5 flex items-center justify-between">
        ...
        <div className="flex-1 max-w-md mx-8 relative" ref={searchRef}>
          <div className="relative">
            <div className={`relative rounded-full border-2 transition-colors duration-400 ${
              isDarkMode
            ...
            {showSuggestions && (
              ...
              >
                {Object.keys(filteredSuggestions).length > 0 ? (
                  Object.entries(filteredSuggestions).map(([category, data]) => (
                    <div key={category} className="p-2">
                      ...
                      {data.items.map((item, itemIndex) => {
                        const globalIndex = Object.values(filteredSuggestions)
                          .slice(0, Object.keys(filteredSuggestions).indexOf(category))
